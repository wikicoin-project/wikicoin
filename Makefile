#############################################################################
# Makefile for building: wikicoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Mon Dec 2 16:19:09 2013
# Project:  wikicoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_QRCODE=1 -o Makefile wikicoin-qt.pro
#############################################################################
...
Makefile: wikicoin-qt.pro  ../Qt/4.8.5/mkspecs/win32-g++/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 -o Makefile wikicoin-qt.pro
...
clean: debug-clean release-clean FORCE
	-$(DEL_FILE) C:/wikicoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/wikicoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/wikicoin/src/leveldb/libleveldb.a: FORCE
