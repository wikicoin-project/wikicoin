...
uint256 hashGenesisBlock("0x00000b108f705ac9dae5e6db4f5736b324bef08328e1d2276faab7eac30f85db");
static const unsigned int timeGenesisBlock = 1391029607;
...
const string strMessageMagic = "WikiCoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "WikiCoin is Born!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x95c2a6047d4aed3274203b2a6857852c3f017e2c2aef7d101bb432451e84987e "));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("WikiCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("WikiCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("WikiCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("wikicoin-miner");
    ...
    try { loop {
        ...
        printf("Running WikiCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("WikiCoinMiner terminated\n");
        throw;
    }
}
