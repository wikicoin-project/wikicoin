...
const QString BITCOIN_IPC_PREFIX("wikicoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click wikicoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start wikicoin: click-to-pay handler");
    else
...
{
    // clicking on wikicoin: URLs creates FileOpen events on the Mac:
